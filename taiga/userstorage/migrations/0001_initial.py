    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "modified_date",
                    models.DateTimeField(verbose_name="modified date", auto_now=True),
                ),
                ("key", models.CharField(max_length=255, verbose_name="key")),
                (
                    "value",
                    taiga.base.db.models.fields.JSONField(
                        verbose_name="value", blank=True, default=None, null=True
                    ),
                ),
                (
                    "owner",
        ...
        migrations.AlterUniqueTogether(
            name="storageentry", unique_together=set([("owner", "key")]),
        ),
    ]
