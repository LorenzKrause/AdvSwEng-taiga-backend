...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="creado el"
                    ),
                ),
                (
                    "token",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        max_length=250, unique=True, verbose_name="slug", blank=True
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        null=True,
                        default=0,
                        verbose_name="total of milestones",
                        blank=True,
                    ),
                ),
                (
                    "total_story_points",
                    models.FloatField(default=0, verbose_name="total story points"),
                ),
                (
                    "is_backlog_activated",
                    models.BooleanField(
                        default=True, verbose_name="active backlog panel"
                    ),
                ),
                (
                    "is_kanban_activated",
                    models.BooleanField(
                        default=False, verbose_name="active kanban panel"
                    ),
                ),
                (
                    "is_wiki_activated",
                    models.BooleanField(default=True, verbose_name="active wiki panel"),
                ),
                (
                    "is_issues_activated",
                    models.BooleanField(
                        default=True, verbose_name="active issues panel"
                    ),
                ),
                (
                    "videoconferences",
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=django.contrib.postgres.fields.ArrayField(
                            base_field=models.TextField(blank=True, null=True), size=2
                        ),
                        blank=True,
                        default=[],
                        null=True,
                        size=None,
                        verbose_name="tags colors",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="project",
            field=models.ForeignKey(
                default=1, to="projects.Project", related_name="memberships"
            ),
            preserve_default=False,
        ),
        migrations.AlterUniqueTogether(
            name="membership", unique_together=set([("user", "project")]),
        ),
        migrations.AddField(
            model_name="membership",
            name="role",
            field=models.ForeignKey(
                related_name="memberships", to="users.Role", default=1
            ),
            preserve_default=False,
        ),
    ]
