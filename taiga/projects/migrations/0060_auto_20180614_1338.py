    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "by_default",
                    models.BooleanField(default=False, verbose_name="by default"),
                ),
                (
                    "color",
                    models.CharField(
                ...
                (
                    "days_to_due",
                    models.IntegerField(
                        blank=True, default=None, null=True, verbose_name="days to due"
                    ),
                ),
                (
                    "project",
        ...
        migrations.AddField(
            ...
            name="issue_duedates",
            field=taiga.base.db.models.fields.json.JSONField(
                blank=True,
                encoder=django.core.serializers.json.DjangoJSONEncoder,
                null=True,
                verbose_name="issue duedates",
            ),
        ),
        migrations.AddField(
            model_name="projecttemplate",
        ...
        migrations.AlterUniqueTogether(
            name="userstoryduedate", unique_together=set([("project", "name")]),
        ),
        migrations.AlterUniqueTogether(
            name="taskduedate", unique_together=set([("project", "name")]),
        ),
        migrations.AlterUniqueTogether(
            name="issueduedate", unique_together=set([("project", "name")]),
        ),
    ]
