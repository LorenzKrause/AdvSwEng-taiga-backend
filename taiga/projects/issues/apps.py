...
def connect_issues_signals():
    ...
    # Finished date
    signals.pre_save.connect(
        handlers.set_finished_date_when_edit_issue,
        sender=apps.get_model("issues", "Issue"),
    ...
    signals.post_save.connect(
        handlers.try_to_close_or_open_milestone_when_create_or_edit_issue,
        sender=apps.get_model("issues", "Issue"),
        dispatch_uid="try_to_close_or_open_milestone_when_create_or_edit_issue",
    )
    signals.post_delete.connect(
        handlers.try_to_close_milestone_when_delete_issue,
        sender=apps.get_model("issues", "Issue"),
...
def connect_issues_custom_attributes_signals():
    ...
    signals.post_save.connect(
        custom_attributes_handlers.create_custom_attribute_value_when_create_issue,
        sender=apps.get_model("issues", "Issue"),
...
def disconnect_issues_signals():
    signals.pre_save.disconnect(
        sender=apps.get_model("issues", "Issue"), dispatch_uid="cached_prev_issue"
    )
