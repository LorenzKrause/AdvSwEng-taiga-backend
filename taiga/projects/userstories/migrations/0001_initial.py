...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.ForeignKey(
                        verbose_name="role", to="users.Role", related_name="role_points"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "blocked_note",
                    models.TextField(
                        default="", blank=True, verbose_name="blocked note"
                    ),
                ),
                (
                    "ref",
                ...
                (
                    "order",
                    models.PositiveSmallIntegerField(default=100, verbose_name="order"),
                ),
                (
                    "created_date",
                ...
                (
                    "client_requirement",
                    models.BooleanField(
                        default=False, verbose_name="is client requirement"
                    ),
                ),
                (
                    "team_requirement",
                    models.BooleanField(
                        default=False, verbose_name="is team requirement"
                    ),
                ),
                (
                    "assigned_to",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        null=True,
                        verbose_name="generated from issue",
                        to="issues.Issue",
                ...
                (
                    ...
                    models.ManyToManyField(
                        through="userstories.RolePoints",
                ...
                (
                    ...
                    models.ManyToManyField(
                        to=settings.AUTH_USER_MODEL,
                        related_name="userstories_userstory+",
                        blank=True,
                        null=True,
                        verbose_name="watchers",
                    ),
                ),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name="rolepoints", unique_together=set([("user_story", "role")]),
        ),
    ]
