...
def send_contact_email(contact_entry_id):
    ...
    ctx = {
        ...
        "project_settings_url": resolve_front_url(
            "project-admin", contact_entry.project.slug
        ),
    }
    users = contact_entry.project.get_users(with_admin_privileges=True).exclude(
        id=contact_entry.user_id
    )
