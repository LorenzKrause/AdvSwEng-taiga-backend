...
def connect_memberships_signals():
    ...
    signals.pre_delete.connect(
        handlers.membership_post_delete,
...
def connect_us_status_signals():
    ...
    signals.post_save.connect(
        handlers.try_to_close_or_open_user_stories_when_edit_us_status,
...
def connect_task_status_signals():
    ...
    signals.post_save.connect(
        handlers.try_to_close_or_open_user_stories_when_edit_task_status,
