    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_blocked",
                    models.BooleanField(verbose_name="is blocked", default=False),
                ),
                (
                    "blocked_note",
                    models.TextField(
                        blank=True, verbose_name="blocked note", default=""
                    ),
                ),
                (
                    "ref",
                ...
                (
                    "finished_date",
                    models.DateTimeField(
                        null=True, blank=True, verbose_name="finished date"
                    ),
                ),
                ...
                (
                    "is_iocaine",
                    models.BooleanField(verbose_name="is iocaine", default=False),
                ),
                (
                    "assigned_to",
                    models.ForeignKey(
