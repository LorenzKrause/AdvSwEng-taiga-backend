...
FROM milestones_milestone_watchers INNER JOIN milestones_milestone ON milestones_milestone_watchers.milestone_id = milestones_milestone.id""".format(
        content_type_id=ContentType.objects.get(model="milestone").id
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="milestone", name="watchers",),
    ]
