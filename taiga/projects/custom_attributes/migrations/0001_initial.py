...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="issuecustomattributes",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        to="projects.Project",
                        verbose_name="project",
                        related_name="taskcustomattributes",
                    ),
                ),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name="userstorycustomattribute", unique_together=set([("project", "name")]),
        ),
        migrations.AlterUniqueTogether(
            name="taskcustomattribute", unique_together=set([("project", "name")]),
        ),
        migrations.AlterUniqueTogether(
            name="issuecustomattribute", unique_together=set([("project", "name")]),
        ),
    ]
