        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(
                        max_length=75, blank=True, verbose_name="email address"
                    ),
                ),
                (
                    "is_active",
                ...
                (
                    "full_name",
                    models.CharField(
                        max_length=256, blank=True, verbose_name="full name"
                    ),
                ),
                (
                    "color",
                    models.CharField(
                        default=taiga.users.models.generate_random_hex_color,
                        max_length=9,
                        blank=True,
                        verbose_name="color",
                    ),
                ...
                (
                    "bio",
                    models.TextField(default="", blank=True, verbose_name="biography"),
                ),
                (
                    "photo",
                    models.FileField(
                ...
                (
                    "colorize_tags",
                    models.BooleanField(default=False, verbose_name="colorize tags"),
                ),
                (
                    "token",
                    models.CharField(
                ...
                (
                    "github_id",
                    models.IntegerField(
                        null=True, blank=True, verbose_name="github ID"
                    ),
                ),
            ],
            options={
